        ...
        <div className={`account-container col-4  ${accountform ? "form-open" : ""}`}>
          ...
          <div className="account-container2 col-12">
            <div className='account-header col-12'>
              ...
              <button className="header-button" onClick={handleActClose}>
                <RxCross2 />
              </button>
            </div>

            <div className="accounttype_container col-6"></div>
            <div className="sub-account col-6">
              <div className="account_info" style={{ color: showAccountInfo ? 'green' : 'inherit' }}>
